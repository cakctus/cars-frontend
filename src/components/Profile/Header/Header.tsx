...
const Header = ({
  ...
  return (
    <div className={styles.headerHead}>
      <div
        className={styles.profilePhotoBlock}
        style={{ display: profilePhoto ? "block" : "none" }}
      >
        <img className={styles.profilePhotoWidth} src={profilePhoto} alt="" />
        <svg
      ...
      <div className={styles.userPhoto}>
        <div className={styles.photo}>
          <img
            className={styles.photoAbsolute}
            width={110}
            src={userPhoto}
            alt=""
          />
        ...
        <div className={styles.headerButtons}>
          <div>
            <button onClick={handleCande} className={styles.cancelButton}>
              Cancel
            </button>
          </div>
          <div>
